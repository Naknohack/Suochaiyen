--[[
    NAK HUB - FULL SCRIPT WITH NEW FLUENT UI
    ALL ORIGINAL FEATURES PRESERVED
    ONLY UI CHANGED TO FLUENT LIBRARY
]]

-- Part 1: Keep all initial code (lines 1-3529)
...
-- ═══════════════════════════════════════════════════
--     FLUENT UI LIBRARY REPLACEMENT (Lines 3530-5037)
-- ═══════════════════════════════════════════════════

local Fluent = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))()

local UI = {Enabled = true}
local library = {}
    ...
    function tabs:Tab(Name, icon)
        ...
        function sections:Section(Name, side)
            ...
            function functionitem:Slider(Name, min, max, set, callback)
                ...
                local slider = tab:AddSlider(Name, {
                    Title = Name,
                    Min = min or 0,
                    Max = max or 100,
                    Default = set or 0,
            ...
            function functionitem:Dropdown(Name, options, callback)
                ...
                local dropdown = tab:AddDropdown(Name, {
                    Title = Name,
                    Values = options,
                    Default = 1
                })
