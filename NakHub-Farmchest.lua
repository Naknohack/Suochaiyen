...
if CoreGui:FindFirstChild("Nak Hub") then
...
glow.Image = "rbxassetid://100306458933414"
...
text.Text = "Nak Hub-Auto Farm chest"
...
local function applyPurpleAura(char)
    ...
    aura.FillColor = Color3.fromRGB(255, 0, 0)   -- tím neon
    aura.OutlineColor = Color3.fromRGB(255, 120, 120)
...
local function ShowBlackScreen()
    ...
    text2.Text = "Hopping"
    text2.TextColor3 = Color3.fromRGB(255, 80, 80)
...
local function createToggle(name, posY, default, callback)
    ...
    title.Text = name
    title.TextColor3 = Color3.fromRGB(255, 0, 0) -- 💜 ghi chú màu tím
    ...
    local function updateVisual()
        if state then
            btn.BackgroundColor3 = Color3.fromRGB(255, 0, 0) -- tím khi on
            btn.Text = "✓"
        else
