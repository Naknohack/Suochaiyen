--[[
    NCT Hub | NGCONGTHANH
    STATUS: FIX LỖI CÚ PHÁP & TỐI ƯU
]]

local Fluent = loadstring(game:HttpGet("https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))()

local Window = Fluent:CreateWindow({
    Title = "NCT Hub | NGCONGTHANH",
    SubTitle = "by CongThanh iOS",
    Image = "rbxassetid://122126282862563", -- Đã thêm dấu phẩy ở đây
    TabWidth = 160,
...
-- ========== HỆ THỐNG FIX LAG (TỪ FILE GỐC CỦA BẠN) ==========
pcall(function()
...
-- ========== DỌN DẸP HIỆU ỨNG RÁC ==========
task.spawn(function()
    while task.wait(5) do
        pcall(function()
            for _, v in pairs(workspace:GetDescendants()) do
                if v:IsA("ParticleEmitter") or v:IsA("Trail") or v:IsA("Smoke") or v:IsA("Fire") or v:IsA("SpotLight") then
                    v.Enabled = false
...
Tabs.Main:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({ Title = "NCT Hub", Content = "Anti-AFK đã bật!", Duration = 5 })
    end
})
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/CongThanhios/thanhioslib/refs/heads/main/LOLCTNE"))()
...
-- ==========================================
Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/CongThanhios/thanhioslib/refs/heads/main/Congthanhioslib"))()
-- ==========================================
...
Tabs.Info:AddButton({
    ["Title"] = "NCT Script | Community",
    ["Description"] = "Discord",
    ["Callback"] = function()
        setclipboard(tostring("https://discord.gg/Wahhqq3H"))
    end
})
Tabs.Info:AddButton({
    ["Title"] = "Youtube",
...
Tabs.Info:AddButton({
    ...
    ["Description"] = "Tiktok",
    ["Callback"] = function()
        setclipboard(tostring("www.tiktok.com/@ngcongthanh06"))
    end
})
